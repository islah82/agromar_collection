...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'frmListShop',
          path: '/frmListShop',
          builder: (context, params) => const FrmListShopWidget(),
        ),
        FFRoute(
          name: 'frmshoplist',
          path: '/frmshoplist',
          builder: (context, params) => const FrmshoplistWidget(),
        ),
        FFRoute(
          name: 'frmRecordTransaction',
          path: '/frmRecordTransaction',
        ...
        FFRoute(
          ...
          builder: (context, params) => FrmListOFLOTCmonthWidget(
            shop: params.getParam('shop', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'frmListOFLOTCmonthCopy',
          path: '/frmListOFLOTCmonthCopy',
          builder: (context, params) => FrmListOFLOTCmonthCopyWidget(
            currentDatepara:
                params.getParam('currentDatepara', ParamType.String),
          ),
        ),
        FFRoute(
          name: 'frmListOFLOTCMonth2',
          path: '/frmListOFLOTCMonth2',
          builder: (context, params) => FrmListOFLOTCMonth2Widget(
            currentDatepara:
                params.getParam('currentDatepara', ParamType.String),
          ),
        ),
